...
<div class="main-login">
    ...
    <h1 class="h-one">Área do Cliente</h1>
            <img src="<?php echo base_url() ?>assets/img/forms-animate.svg"class="left-login-imagec" alt="Cloud-OS 5.0">
        </div>
                        ...
                        <div class="content">
                            <div id="newlog">
                              ...
                              <div class="control-group">
                                ...
                                <div class="links-uteis"><a href="https://github.com/gambiarraweb1/cloudos"><p><?= date('Y'); ?> &copy; Diego Pereira</p></a></div>
                            </div>
                        </div>
                    </div>
                </div>

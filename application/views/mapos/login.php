...
<h2 class="h-two"> Ao Sistema de Controle de Ordens de Serviço</h2>
    <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Cloud-OS - Versão: <?= $this->config->item('app_version'); ?>">
</div>
<div id="loginbox">
        ...
        <div class="container">
          <div class="card">
            <div class="content">
              ...
              <div class="links-uteis"><a href="https://github.com/gambiarraweb1/cloudos"><p><?= date('Y'); ?> &copy; Diego Pereira</p></a>
              </div>
              <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
              <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <h4 id="myModalLabel">Cloud-OS</h4>
                </div>
